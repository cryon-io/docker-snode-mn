...
ver=$(./get-version.sh)
type="SNODE_MN"
mn_status="$(/home/snode/snodecoin-cli masternode status 2>&1)"
...
block_count="$(/home/snode/snodecoin-cli getblockchaininfo 2>&1)"
...
sync_status="$(/home/snode/snodecoin-cli mnsync status 2>&1)"
...
BLOCKS: %s
SYNCED: %s
" "$type" "$ver" "$mn_status" "$block_count" "$sync_status"> /home/snode/.snodecoin/node.info
